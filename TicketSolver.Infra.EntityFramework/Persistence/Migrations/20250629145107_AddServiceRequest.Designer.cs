...
namespace TicketSolver.Infra.EntityFramework.Persistence.Migrations
{
    ...
    [Migration("20250629145107_AddServiceRequest")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("TicketSolver.Domain.Persistence.Tables.Service.ServiceAddress", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("TicketSolver.Domain.Persistence.Tables.Service.ServiceAvailableSlots", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.ToTable("ServiceAvailableSlots");
                });

            modelBuilder.Entity("TicketSolver.Domain.Persistence.Tables.Service.ServiceRequest", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.Property<string>("AssignedTechId")
                        .HasColumnType("text");
                    ...
                    b.Property<short>("ServicePeriod")
                        .HasColumnType("smallint");

                    b.Property<string>("ServiceReport")
                        .HasColumnType("text");
            ...
            modelBuilder.Entity("TicketSolver.Domain.Persistence.Tables.Service.ServiceAvailableSlots", b =>
                {
                    b.HasOne("TicketSolver.Domain.Persistence.Tables.Service.ServiceRequest", "ServiceRequest")
            ...
            modelBuilder.Entity("TicketSolver.Domain.Persistence.Tables.Service.ServiceRequest", b =>
                {
                    b.HasOne("TicketSolver.Domain.Persistence.Tables.Service.ServiceAddress", "Address")
                        .WithMany()
                        .HasForeignKey("AddressId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("TicketSolver.Domain.Persistence.Tables.User.Users", "AssignedTech")
                        .WithMany()
                        .HasForeignKey("AssignedTechId");

                    b.HasOne("TicketSolver.Domain.Persistence.Tables.User.Users", "RequestedBy")
                        .WithMany()
