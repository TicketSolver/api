        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AssignedTechId = table.Column<string>(type: "text", nullable: true),
                    ServiceDate = table.Column<DateTime>(type: "timestamp without time zone", nullable: false),
                    ServicePeriod = table.Column<short>(type: "smallint", nullable: false),
                    Status = table.Column<short>(type: "smallint", nullable: false),
                    ServiceReport = table.Column<string>(type: "text", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ServiceRequests_IdentityUsers_AssignedTechId",
                        column: x => x.AssignedTechId,
                        principalTable: "IdentityUsers",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_ServiceRequests_IdentityUsers_RequestedById",
                        column: x => x.RequestedById,
                        principalTable: "IdentityUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ServiceRequests_ServiceAddresses_AddressId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ServiceAvailableSlots", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ServiceAvailableSlots_ServiceRequests_ServiceRequestId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ServiceAvailableSlots_ServiceRequestId",
                table: "ServiceAvailableSlots",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ServiceRequests_AssignedTechId",
                table: "ServiceRequests",
