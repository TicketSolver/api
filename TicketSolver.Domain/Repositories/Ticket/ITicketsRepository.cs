...
public interface ITicketsRepository<TTickets> : IRepositoryBase<TTickets>
{
    ...
    Task<PaginatedResponse<TTickets>> GetAllByTechAsync(CancellationToken cancellationToken, string techId,
        PaginatedQuery paginatedQuery);

    Task<PaginatedResponse<TTickets>> GetHistoryByTechAsync(CancellationToken cancellationToken, string techId,
        PaginatedQuery paginatedQuery);
...
public interface ITicketsRepository : ITicketsRepository<Tickets>
{
}